...
<script type="text/x-jquery-tmpl" id="t1">
                            ...
                            <div class="listimg"><a href="categories?id=${'${'}id}" title="" 
                            ...
                            <div class="listinfo">
                                <div class="listtitle"><a href="categories?id=${'${'}id}"
                                                          title="" target="_blank">${'${'}descs}</a>
                                </div>
                                <div class="listtag"><a href="categories?id=${'${'}id}" rel="tag">${'${'}name}</a></div>
